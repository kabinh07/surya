...
from surya.common.donut.processor import EncoderImageProcessor
from surya.recognition.tokenizer import Byt5LangTokenizer
from surya.settings import settings

class Processor(S3DownloaderMixin, DonutProcessor):
    def __init__(self, checkpoint,  image_processor=None, tokenizer=None, **kwargs):
        image_processor = EncoderImageProcessor.from_pretrained(checkpoint)
